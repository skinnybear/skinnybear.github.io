...
var HelloDragonBones = (function (t) {
  function e() {
    ...
    return (
      e._resources.push(
        "resource/mecha_1002_101d_show/Leib05_ske.dbbin",
        "resource/mecha_1002_101d_show/Leib05_tex.json",
        "resource/mecha_1002_101d_show/Leib05_tex.png"
      ),
      e
    );
  }
  return (
    ...
    (e.prototype._onStart = function () {
      ...
      var e = t.buildArmatureDisplay("ArmatureLeib", "Leib05");
      e.animation.play("LeibSpelling"), (e.x = 0), (e.y = 200), this.addChild(e);
    }),
    e
  );
})(BaseDemo);
