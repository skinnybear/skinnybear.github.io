...
var HelloDragonBones = (function (t) {
  function e() {
    ...
    return (
      e._resources.push(
        "resource/Ded_5_ske.dbbin",
        "resource/Ded_5_tex.json",
        "resource/Ded_5_tex.png"
      ),
      e
    );
  }
  return (
    ...
    (e.prototype._onStart = function () {
      ...
      var e = t.buildArmatureDisplay("Ded_Moroz", "Ded_5");
      e.animation.play("Idle"), (e.x = 0), (e.y = 300), this.addChild(e);
    }),
    e
  );
})(BaseDemo);
