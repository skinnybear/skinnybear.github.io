...
var HelloDragonBones = (function (t) {
  function e() {
    ...
    return (
      e._resources.push(
        "resource/gomeisa/Gomeisa_ske.dbbin",
        "resource/gomeisa/Gomeisa_tex.json",
        "resource/gomeisa/Gomeisa_tex.png"
      ),
      e
    );
  }
  return (
    ...
    (e.prototype._onStart = function () {
      ...
      e.animation.play("dance"), (e.x = 0), (e.y = 500), this.addChild(e);
    }),
    e
  );
})(BaseDemo);
